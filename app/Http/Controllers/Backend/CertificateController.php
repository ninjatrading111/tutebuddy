...
class CertificateController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $admin = $certificate->course->teachers->first();
        $data = [
            'name' => auth()->user()->name,
    ...
    public function getCertificates()
    {
        ...
        foreach($certificates as $cert) {
            ...
            $temp['title'] = '<div class="media flex-nowrap align-items-center" style="white-space: nowrap;">
                                <div class="avatar avatar-sm mr-8pt">
                                    <span class="avatar-title rounded bg-primary text-white">'
                                        . mb_substr($cert->course->title, 0, 2) .
                                    '</span>
                                </div>
            ...
            if (auth()->user()->certificates()->where('course_id', '=', $cert->course->id)->first()) {
                $btn_download = '<a href="' . route('admin.certificates.download', ['certificate_id'=>$cert->id]) . 
                    '" class="btn btn-primary btn-sm">Download</a>';
            } else {
                $btn_download = '<a href="javascript(void:0)" class="btn btn-primary btn-sm" data-toggle="tooltip" 
                    data-title="Certificate is not generated by admin">Locked</a>';
            }
