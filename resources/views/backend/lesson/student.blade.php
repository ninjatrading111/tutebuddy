...
<div class="mdk-header-layout__content page-content ">
    ...
    <div class="container page__container page-section">
        <div class="page-separator">
            <div class="page-separator__text">@lang('labels.backend.lessons.my_live_lessons')</div>
        </div>
        ...
        <div class="card dashboard-area-tabs p-relative o-hidden mb-lg-32pt">
            ...
            <div class="card-header p-0 nav">
                <div id="tbl_selector" class="row no-gutters" role="tablist">
                    <div class="col-auto border-right border-bottom">
                        <a href="{{ route('admin.student.getLiveSessionsByAjax', 'today') }}" data-toggle="tab" role="tab" aria-selected="true"
                            class="dashboard-area-tabs__tab card-body d-flex flex-row align-items-center justify-content-start active">
                            <span class="h2 mb-0 mr-3 count-today">{{ $count['today'] }}</span>
                            <span class="flex d-flex flex-column">
                                <strong class="card-title">@lang('labels.backend.lessons.today_scheduled')</strong>
                                <small class="card-subtitle text-50">@lang('labels.backend.lessons.today_scheduled_description')</small>
                            </span>
                        </a>
                    </div>
                    <div class="col-auto border-left border-right">
                        <a href="{{ route('admin.student.getLiveSessionsByAjax', 'all') }}" data-toggle="tab" role="tab" 
                            ...
                            <span class="flex d-flex flex-column">
                                ...
                                <small class="card-subtitle text-50">@lang('labels.backend.lessons.all_live_lessons')</small>
                            </span>
                        </a>
                    </div>
                </div>
                ...
                <table id="tbl_lessons" class="table mb-0 thead-border-top-0 table-nowra" data-page-length='50'>
                    <thead>
                        <tr>
                            ...
                            <th>@lang('labels.backend.table.course_title')</th>
                            <th>@lang('labels.backend.table.lesson_title')</th>
