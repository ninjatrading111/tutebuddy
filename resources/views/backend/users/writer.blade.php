...
{{-- 
    <div class="page-section bg-ligth">
        <div class="container  d-flex flex-column flex-md-row align-items-center text-center text-md-left">

            <div class="flex ">
                <h2 class="text-primary mb-0">Manage All Writers of Here</h2>
                <p class="lead text-primary-50 d-flex align-items-center float-right">
                    <button type="button" class="btn btn-success text-white icon-16pt" id="add">Add New
                        Writer</button>
                <div class="modal fade" id="modal_user" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content ">
                            ...
                            <form method='post' id='writer_form' action='/'>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-separator mb-6">
                        <div class="page-separator__text">All Writers List</div>
                    </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/jquery.validate.js"></script> --}}
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('submit', '#writer_form', function(e) {
                    e.preventDefault();
                    var form_data = $('#writer_form').serialize();
                    console.log(form_data);
                    $.ajax({
                        url: '/dashboard/writer/postdata',
                        method: 'post',
                        data: form_data,
                        dataType: 'json',
                ...
                $(document).on('click','.edit',function(){
                    ...
                    $.ajax({
                        url:'/dashboard/writer/fetchdata',
                        method:'post',
                        data:{id:id},
                        dataType:'json',
                        success:function(res){
                ...
                $(document).on('click','.delete',function(){
                    ...
                    // console.log(id);
                    $.ajax({
                        url:'/dashboard/writer/removedata',
                        method:'post',
                        data:{id:id},
                        dataType:'json',
                        success:function(res){
