                    ...
                    <div class="card m-0">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subject" id="subject" class="form-control" placeholder="Email Subject">
                            </div>
                                                ...
                                                <div id="content_html">
                                                    ...
                                                    <div style="Margin:0px auto;max-width:604px;">
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; direction: ltr; font-size: 0px; padding: 15px 0px 40px; text-align: center; vertical-align: top;"
                                                                        align="center">
    ...
    <script>
        $(function () {
            ...
            $('#btn_save').on('click', function(e) {
                $('#content').val(content_editor.root.innerHTML);
                $('#html_content').val($('#content_html').html());
                $('#frm_template').submit();
            });
        });
