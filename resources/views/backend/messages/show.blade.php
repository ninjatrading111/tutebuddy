                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="flex" data-perfect-scrollbar>
                            ...
                            <ul id="recent_chats" class="list-group list-group-flush mb-3">
                                ...
                                <li class="list-group-item px-3 py-12pt bg-light" data-id="{{ $partner->id }}" data-thread="{{ $thread->id }}">
                                    <a href="javascript:void(0)" class="d-flex align-items-center position-relative">
                                        <span class="avatar avatar-xs avatar-online mr-3 flex-shrink-0">
                                            ...
                                            <img src="{{ asset('/storage/avatars/' . $partner->avatar) }}" alt="" class="avatar-img rounded-circle">
                                            @else
                                            <span class="avatar-title rounded-circle">{{ mb_substr($partner->avatar, 0, 2) }}</span>
                                            @endif

                                        </span>
                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                            <strong class="text-body">{{ $partner->name }}</strong>
