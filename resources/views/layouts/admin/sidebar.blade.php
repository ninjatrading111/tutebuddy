            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="sidebar-submenu collapse sm-indent" id="task_menu1" style="">
                        ...
                        <li class="sidebar-menu-item {{ Request::is('dashboard/client*') ? 'active' : '' }}">
                            <a class="sidebar-menu-button" href="/dashboard/client">
                                <span class="sidebar-menu-text">All Clients</span>
                            </a>
                        </li>
                        {{-- @endcan

                        @can('test_access') --}}
                        <li class="sidebar-menu-item {{ Request::is('dashboard/writer*') ? 'active' : '' }}">
                            <a class="sidebar-menu-button" href="/dashboard/writer">
                                <span class="sidebar-menu-text">All Writers</span>
                            </a>
                        </li>
                    </ul>
                </li>
