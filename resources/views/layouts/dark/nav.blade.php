...
<?php
$nav_class = \Request::route()->getName() == 'homepage' ? 'navbar-dark navbar-dark-dodger-blue bg-transparent will-fade-background' : 'navbar-dark bg-black navbar-dark-dodger-blue bg-transparent will-fade-background';
?>
    ...
    @else
        ...
        <div class="nav navbar-nav flex-nowrap d-flex mr-16pt">
            ...
            <div class="nav-item dropdown" data-toggle="tooltip" data-title="Setting Mode">
                ...
                <div class="dropdown-menu dropdown-bg-dark dropdown-menu-right">
                    <a class="dropdown-item text-white" href="/layouts/light">Light</a>
                    <a class="dropdown-item text-white" href="/layouts/dark">Dark</a>
                </div>
            </div>
            ...
            <div class="nav-item dropdown" data-toggle="tooltip" data-title="My Account">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-bg-dark ">
                    <div class="dropdown-item text-white">
                        <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">face</span>
                        <span class="sidebar-menu-text">{{ auth()->user()->firstname }}</span>
                        ({{ auth()->user()->lastname }})
                    </div>
