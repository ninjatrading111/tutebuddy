...
<div class="js-fix-footer2 bg-black border-top-2 position-relative">
        ...
        <div class="row pb-16pt mb-16pt border-bottom-2">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <ul class="footer-menu">
                    <li class="footer-menu-item text-white ">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                <div class="text-center pt-16pt">
                    <strong class="js-lists-values-project text-white">Copyright 2020 &copy; All rights reserved.</strong>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                <div class="text-center pt-16pt">
                    <a href="/page/terms-and-conditions" class=" text-white">Terms of Service</a> | <a href="/page/support"  class="text-white">Support</a>
                </div>
            </div>
        </div> 
    </div>
