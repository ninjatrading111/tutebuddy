...
<div class="mdk-drawer js-mdk-drawer" id="default-drawer">
    <div class="mdk-drawer__content">
        <div class="sidebar sidebar-black bg-black sidebar-black-dodger-blue sidebar-left" data-perfect-scrollbar>

            <a href="#" class="sidebar-brand ">
                <span class="avatar avatar-xl sidebar-brand-icon h-auto">
                    <img src="{{ asset('assets/img/logo/white-100@2x.png') }} "
                        alt="logo" class="img-fluid" />
                </span>
            </a>
            <!-- Sidebar Head -->
            <div class="sidebar-heading text-white">{{ auth()->user()->role }}</div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="sidebar-submenu collapse sm-indent" id="task_menu" style="">
                        {{-- @can('assignment_access') --}}
                        <li class="sidebar-menu-item {{ Request::is('ordering/writing*') ? 'active' : '' }}">
                            <a class="sidebar-menu-button" href="/ordering/writing">
