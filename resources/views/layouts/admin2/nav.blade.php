...
@endif
    ...
    ?>
        ...
        <div class="navbar navbar-expand {{ $nav_class }}" id="default-navbar" data-primary>
            ...
            @if(auth()->check())
            <!-- Navbar toggler -->
            <button class="navbar-toggler w-auto mr-16pt rounded-0" type="button" data-toggle="sidebar">
            ...
            <div class="nav navbar-nav flex-nowrap d-flex mr-16pt">
                ...
                <div class="nav-item" data-toggle="tooltip" data-title="Light Mode/Dark Mode">
                    <a href="{{ route('admin.switchMode') }}" class="nav-link btn-flush" type="button">
                        <i class="material-icons">brightness_4</i>
                    </a>
                </div>
                <!-- Dashboard link -->
                <div class="nav-item" data-toggle="tooltip" data-title="Dashboard">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link btn-flush" type="button">
                        <i class="material-icons">dashboard</i>
                    </a>
                </div>
                
                <!-- Notifications dropdown -->
                <div class="nav-item dropdown dropdown-notifications dropdown-xs-down-full" data-toggle="tooltip" data-title="Message">
                    <button class="nav-link btn-flush dropdown-toggle" type="button" data-toggle="dropdown" data-caret="false">
                                ...
                                <a href="{{ route('admin.messages.show', [$notify['msg']->thread_id, $partner_user->id]) }}"
                                    ...
                                    <span class="d-flex">
                                        <span class="avatar avatar-xs mr-2">
                                            ...
                                            @else
                                            <span class="avatar-title rounded-circle">{{ mb_substr($partner_user->avatar, 0, 2) }}</span>
                                            @endif
                                        </span>
                                        <span class="flex d-flex flex-column">
                ...
                <li class="nav-item">
                    <!-- Multi Language Option -->
                    <div class="nav-item dropdown dropdown-notifications dropdown-xs-down-full" data-toggle="tooltip" data-title="Language">
                        <button class="nav-link btn-flush dropdown-toggle" type="button" data-toggle="dropdown" data-caret="false">
                            <i class="material-icons icon-24pt">language</i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right" style="width: 200px; min-width:200px;">
                ...
                <div class="nav-item dropdown" data-toggle="tooltip" data-title="My Account">
                    <a href="#" class="nav-link d-flex align-items-center dropdown-toggle"
                        ...
                        @else
                        <span class="avatar-title rounded-circle">{{ mb_substr(auth()->user()->name, 0, 2) }}</span>
                        @endif
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="https://blog.tutebuddy.com/">@lang('navs.help_center')</a>
                        <a class="dropdown-item" href="https://support.tutebuddy.com/">@lang('navs.forum')</a>
