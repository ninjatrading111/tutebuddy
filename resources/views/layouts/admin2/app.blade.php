...
<head>
    ...
    <meta name="description" content="Find an admin, guru, teacher or course to learn anything online through self paced learning or Live Sessions. Expert teachers and intsructors available that cover almost any subject. Search, discuss and tailor your course to suit your needs.">
    <meta name="keywords" content="Teaching, Training, Live Sessions, Lessons, Remote Learning, whiteboard, courses,  Online Assessment, E-Learning, Certification, online courses platform, LMS, classroom, tuition, coaching, study, Schools, Institutions">
    ...
    <meta itemprop="description" content="Find an admin, guru, teacher or course to learn anything online through self paced learning or Live Sessions. Expert teachers and intsructors available that cover almost any subject. Search, discuss and tailor your course to suit your needs.">
    ...
    <meta property="og:description" content="Find an admin, guru, teacher or course to learn anything online through self paced learning or Live Sessions. Expert teachers and admins available that cover almost any subject. Search, discuss and tailor your course to suit your needs.">
    ...
    <meta name="twitter:description" content="Find a teacher or guru or course to learn anything online through self paced learning or Live Sessions. Expert teachers and admins for any subject. ">
...
<body class="layout-sticky-subnav layout-default {{ session('isDark')? 'dark-mode' : '' }}">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
        @include('layouts.admin2.nav')
        <div class="row" style="border: 1px solid black">
            @if(auth()->check())
                <div class="col-md-2 col-lg-2 sidebar-desktop" style="border:1px solid red">
                    @include('layouts.admin2.sidebarp')
                </div>

                <div class="col-md-10 col-lg-10" style="border:1px solid blue">
                    <!-- Main Content -->
                    @yield('content')
                </div>
            @endif
...
@include('layouts.admin2.parts.sweet-alert')
