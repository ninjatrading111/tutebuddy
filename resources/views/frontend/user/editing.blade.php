  ...
  label {
    ...
    <div class="mdk-header-layout__content page-content ">
        ...
        <div class="page-section dark-bg-black">
            <div class="container dark-bg-black-80 page__container">
                <div class="row">
                    <div class="col-md-12 mx-auto">
                        <div class="page-separator mb-6 ">
                            <div class="page-separator__text">Editing Page</div>
                        </div>
                        <div class="card dark-bg-black">
                            <div class="card-body dark-bg-black-80">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <span class="control-fileupload form-control">
